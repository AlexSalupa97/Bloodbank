 ...
 */
public class StatisticiAnualeCTSFragment extends Fragment {


    public StatisticiAnualeCTSFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Integer[] listaCantitatiIntratePerZi = new Integer[datesInRange.size()];
        Arrays.fill(listaCantitatiIntratePerZi, 0);
        ...
        Integer[] listaCantitatiIesitePerZi = new Integer[datesInRange.size()];
        Arrays.fill(listaCantitatiIesitePerZi, 0);
        for (int i = 0; i < datesInRange.size(); i++) {
