...
public class OptSaptamaniActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_opt_saptamani);

        tv8Saptamani=(TextView)findViewById(R.id.tv8Saptamani);
        tv8Saptamani.setText(tv8Saptamani.getText()+String.valueOf(56-(getIntent().getExtras().getLong("perioadaramasa")/ (60*60*24*1000))));
